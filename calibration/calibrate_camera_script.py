...
if (nPatternFound > 1):
    ...
    cv2.imwrite(resultsFolder + "/calibresult.png",dst)
    ...
    #--------- Save result
    filename = resultsFolder + "/cameraMatrix.txt"
    np.savetxt(filename, mtx, delimiter=',')
    filename = resultsFolder + "/cameraDistortion.txt"
